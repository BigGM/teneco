 ...
 **/
$cmd  = 'BEGIN ' . $proc . '(:id_pkt, :nome, :descr, :pre_req, :contro_ind, :alert_msg, :alert_msg_visibile, :bibliografia, :patologie_secondarie, :valutazione, :note, :contro_ind_abs, :pre_req_comp, :come_valutare,  :outcome); END;'; 
