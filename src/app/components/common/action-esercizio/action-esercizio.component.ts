...
export class ActionEsercizioComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
       ...
       *  ambito = 2   => riabilitazione cognitiva
       *  ambito = 3   => formazione
       ...
       * "modifica_esercizio", 
       * nel primo caso 'obj'  posside un secondo campo 'id_pkt' con l'id del pacchetto a cui il
      ...
      this.listaEsercizi.openActionEsercizio.subscribe (obj => {
          ...
          if (this.azione=="nuovo_esercizio") {
              ...
              this.titolo = this.AMBITO==1 || this.AMBITO==2 ? "Modifica esercizio" : "Modifica modalità"
  ...
  salvaEsercizio(form) {
    ...
    this.exSubscr = serv.subscribe (
      result => {
        ...
        // Aggiorna la lista degli esercizi del pacchetto e al termine, con la callback,
        // aggiorna il campo della UI che mostra questo valore.
        this.listaEsercizi.reloadEserciziPacchetto( function() {
          self.listaEsercizi.updateNumEsercizi()
        })
